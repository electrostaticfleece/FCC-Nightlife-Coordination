...
import icon from 'images/paperplane.png';
...
const config = {
  ...
  meta: [
    ...
    { name: 'description', content: 'A nightlife coordination application ' },
    ...
    { name: 'apple-mobile-web-app-title', content: 'Rendezvous - Meet, Mix, Mingle' },
